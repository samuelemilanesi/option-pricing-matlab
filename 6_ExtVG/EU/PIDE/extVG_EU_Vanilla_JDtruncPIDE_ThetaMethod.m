...
fprintf('EU Vanilla prices under extended VG model using PIDE theta method with theta=%d and operator splitting for JD processes after small jumps trunction',theta)
