%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price European Call and Put and Options under extVG model
...
% adjust the vol with the GBM part
...
fprintf('EU Vanilla prices under extended VG model using PIDE theta method with theta=%d and operator splitting for General Levy processes',theta)
