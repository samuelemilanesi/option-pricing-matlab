%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price Lookback Fixed strike call option under Kou model 
...
disp("Kou Model - Lookback fixed strike call option price MC with Antithetic Variance reduction:")
[lb_fixedStrike_call_price, ~, lb_fixedStrike_call_price_CI] = normfit( (DiscPayoff+DiscPayoffAV)/2 )
