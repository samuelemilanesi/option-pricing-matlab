%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price Barrier D&O and Options under Kou model
...
par = struct('S0',S0,'r',r,'TTM',T,'sigma',sigma,'sigmaGBM',sigmaGBM,...
             'theta',theta,'kNIG',kNIG);
...
fprintf('DO call prices under VG model using PIDE theta method with theta=%d and operator splitting for JD processes after small jumps trunction',theta)
