%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price DO Call and Options under extNIG model
...
fprintf('DO call prices under extNIG model using PIDE theta method with theta=%d and operator splitting for General Levy processes',theta)
