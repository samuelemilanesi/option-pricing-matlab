%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price European Call and Put Options under extNIG model using MC
...
[~,~,ST,STAV] = extNIG_simulate_asset_AV(par,Nsim,1);
...
disp("extNIG Model - EU Vanilla options price via MC with antithetic variance reduction:")
