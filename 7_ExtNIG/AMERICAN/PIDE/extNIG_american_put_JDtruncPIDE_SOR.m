...
fprintf('American Put price under VG model using PIDE theta method with theta=%d and operator splitting for JD process after truncating small jumps',theta)
