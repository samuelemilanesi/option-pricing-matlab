%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price European Call and Put Options under VG model using MC
...
[~,~,ST,STAV] = VG_simulate_asset_AV(par,Nsim,1);
...
disp("VG Model - EU Vanilla options price via MC with antithetic variance reduction:")
