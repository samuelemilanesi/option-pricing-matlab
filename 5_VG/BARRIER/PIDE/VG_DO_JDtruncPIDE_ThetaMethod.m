%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price Barrier D&O option under VG model
...
fprintf('DO Barrier option price under VG model using PIDE theta method with theta=%d and operator splitting for JD processes after small jumps trunction',theta)
