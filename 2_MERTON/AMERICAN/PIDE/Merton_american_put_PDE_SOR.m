%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Price American Put option under Merton model
...
fprintf('American Put price under Merton model using PDE theta method with theta=%d',theta)
Merton_american_put_price= interp1(S0*exp(x_grid), v, S0, 'spline')
